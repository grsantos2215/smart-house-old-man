	...
	<ul class="navbar-nav">
		<li class="logo">
			<a href="index.php" class="nav-link index">
				<span class="link-text logo-text">Houseguard</span>
		...
		<li class="nav-item">
			<a href="index.php" class="nav-link">
				<i class="fa-solid fa-house fa-secondary"></i>
				<span class="link-text">Home</span>
			</a>
		</li>

		<li class="nav-item">
			<a href="lampadas.php" class="nav-link">
				<i class="fa-solid fa-lightbulb fa-secondary"></i>
				<span class="link-text">Lâmpadas</span>
			</a>
		</li>

		<li class="nav-item">
			<a href="camera.php" class="nav-link">
				<i class="fa-solid fa-video fa-secondary"></i>
				<span class="link-text">Câmera</span>
			</a>
		</li>

		<li class="nav-item">
			<a href="dispositivos.php" class="nav-link">
				<i class="fa-solid fa-microchip fa-secondary"></i>
				<span class="link-text">Dispositivos</span>
			</a>
		</li>

		<li class="nav-item">
			<a href="gerenciamento.php" class="nav-link">
				<i class="fa-solid fa-user-gear fa-secondary"></i>
